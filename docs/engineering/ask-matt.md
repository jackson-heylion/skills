...
```bash
npx skills add jackson-heylion/skills --skill=ask-matt
```
...
[Source](https://github.com/jackson-heylion/skills/tree/main/skills/engineering/ask-matt)
